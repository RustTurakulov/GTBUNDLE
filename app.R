...
agrf <- bs_theme(version=4, bootswatch="cosmo", tab_font_size = "60px") %>%
...
ui <- fluidPage(  
  ...
  title = tags$span(imageOutput("logo", height = "10", inline = FALSE), " GT CHIPS ", style = "color: black; font-size: 2px; font-weight: regular;"),
  
  tabPanel(HTML("<span style='font-size:28px; color:white;'>Genes</span>"),
           ...
           sidebarLayout(
             ...
             mainPanel(
               ...
               br(),
               hr(),
               h5("Table with all matched SNPs detected in all selected genes"),
               DTOutput("longtable")
             ),
             fluid = FALSE
           )),
  
  tabPanel(HTML("<span style='font-size:28px; color:white;'>SNPs</span>"),           
           sidebarLayout(
             sidebarPanel(
  ...
  tabPanel(HTML("<span style='font-size:28px; color:white;'>Info</span>"),           
